...
public class FileCaseDialog extends javax.swing.JDialog {
    ...
    public FileCaseDialog(JFrame parent, boolean modal, Court to, Lawyer from) {
        ...
        for(Court court: Network.getInstance().getCOURT().getAllEntries()){
            ComboBoxcourt.addItem(String.valueOf(court));
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
           ...
           // Logger.getLogger(FileCaseDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
        c.setCasetype(txtcasetype.getText());
        c.setCaseDesc(txtcasedescription.getText());
        
        CaseFileRequest req =  (CaseFileRequest) to.getWorkQueue().createNewWorkItem(from.getAccount(),null,null);
